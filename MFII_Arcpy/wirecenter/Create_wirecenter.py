...
import_wirecenters.outputGDB = os.path.join(path_links.basepath, import_wirecenters.outputGDBName + ".gdb")
import_wirecenters.import_shapefiles_to_gdb("*")

# 3---merge output

import_wirecenters.inputGDB = os.path.join(path_links.basepath, import_wirecenters.outputGDBName + ".gdb")
...
left_table_object = get_path.pathFinder(env_0=os.path.join(path_links.basepath, import_wirecenters.outputGDBName + ".gdb"))
...
import_wirecenters.addJoin_and_copy_feature(left_table_path[0], right_table, create_id_field=1, joinField= "id", outpath= os.path.join(
    path_links.basepath, import_wirecenters.outputGDBName + ".gdb", "_merged_wirecenters_pviot"),
