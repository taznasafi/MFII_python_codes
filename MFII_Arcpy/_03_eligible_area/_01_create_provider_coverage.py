...
intersect_coverages.intersect_coverages_by_stateGrid(lte_output_table_folder_path=path_links.inputbasepath)
...
erase_water_areas.erase_water_blocks_from_coverage(lte_table_output_folder=path_links.inputbasepath)
